...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    AddTeacher() {
        ...
        labelempid = new JLabel("222" + first4);
        ...
        lblqualification.setBounds(400, 350, 200, 30);
        ...
        cbqualification.setBounds(600, 350, 150, 30);
       ...
       lbldepartment.setFont(new Font("serif", Font.BOLD, 20));
        ...
        String department[] = {"Computer", "Elec", "Civil", "English", "EEE"};
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "INSERT INTO teacher (name, fname, empid, dob, address, phone, email, x, xii, qualification, department) "
                        + "VALUES ('" + name + "', '" + fname + "', '" + empid + "', '" + dob + "', '" + address + "', '" + phone + "', '" + email + "', '" + x + "', '" + xii + "', '" + qualification+ "', '" + department+ "')";
