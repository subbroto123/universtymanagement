...
public class StudentLeaveRequest extends JFrame implements ActionListener {

    Choice ctime;
    JTextField crollno, trason;
    JDateChooser dcdate;
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){
            ...
            String query ="INSERT INTO studentleave(rollno,date,duration,rason)"
                    + "VALUES('"+rollno+"','"+date+"','"+duration+"','"+rason+"')";
             try{
                Conn con = new Conn();
